...
from ClassClient import VoilierClient
...
class IHM(tk.Frame):
    def __init__(self):
        ...
        self.voilierYann=VoilierClient()
        ...
        self.inputPort = tk.Entry(self, text="8888", width=5)
        self.inputPort.insert(0,"8888")
        self.boutonConnect = tk.Button(self, text="Connect",command=self.connect)
        self.boutonSend = tk.Button(self, text="send",command=self.connect)
        ...
        self.boutonSend.grid(row=6,column=2)
    ...
    def connect(self):
        ...
        self.voilierYann.initcom(ip,port)
        self.log.insert('1.0',ip +"\n")
        self.log.insert('1.0',port+ "\n")
        print ip
        print port
