...
while True:
    ...
    lat1 = int(-48.408817*10000000)
    lon1 = int(4.486207*10000000)
    ...
    print " Valeur Hexa de b3 : ", hex(b4) 
    print " Valeur Hexa de b2 : ", hex(b5)
    print " Valeur Hexa de b1 : ", hex(b6)
    print " Valeur Hexa de bo : ", hex(b7)
